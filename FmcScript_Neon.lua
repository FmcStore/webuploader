...
MakeWindow({
  Hub = {
    Title = "🌐 FmcStore Neon Hub (¥)",
    Animation = "⚡ Welcome to Neon Hub ⚡"
  },
  Key = {
    KeySystem = true,
    Title = "🔷 FmcStore Neon Hub 🔷",
    Description = "Blue Lock Rivals - Neon Edition",
    KeyLink = "https://discord.gg/72q5yvpfEJ",
    Keys = {"zuyiandexecutive", "71838", "28282", "1", "28282"},
    Notifi = {
      Notifications = true,
      CorrectKey = "✅ Access Granted - Neon Flow",
      Incorrectkey = "❌ Invalid Key!",
      CopyKeyLink = "🔗 Discord Link Copied!"
    }
  }
})
...
MinimizeButton({
  ...
  Size = {40, 40},
  Color = Color3.fromRGB(15, 15, 25) -- Darker base for neon,
  Corner = true,
  Stroke = true,
  StrokeColor = Color3.fromHSV(0.55, 1, 1) -- Neon blue glow  -- Hue: 180° for cyan
})
...
local Paragraph1 = AddParagraph(Main, {"Fmc's Official Hub ✅", "CREDIT"})
local Paragraph2 = AddParagraph(Main, {"💡 More Games Coming Soon...", "INFO"})
local Paragraph3 = AddParagraph(Main, {"Only Blue Lock Rivals Supported"})
local Paragraph4 = AddParagraph(Main, {"FmcStore Is The Owner Of This Script"})

-- Auto
local Main = MakeTab({Name = "Custom Styles‼️🔥"})
...
local Important = MakeTab({Name = "Zuyis Portal😜"})
...
AddButton(Important, {
  ...
  Callback = function()
    ...
    game:GetService("StarterGui"):SetCore("SendNotification", {
      Title = "Join FmcStore Hub For Updates!",
...
local NewCosmetics = MakeTab({Name = "New Cosmetics🐐"})
